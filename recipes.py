...
#create URL
https://spoonacular.com/recipes/fried-shrimp-rolls-743121

url = x.replace(' ', '-') + '-' + '743121'

url = title.replace(' ', '-') + '-' + id
'Fried-Shrimp-Rolls-743121'
...
TITLE:
    ...
    {u'title': u'Fried Shrimp Rolls', u'image': u'https://spoonacular.com/recipeImages/743121-312x231.jpeg', u'missedIngredientCount': 9, u'likes': 97, u'usedIngredientCount': 4, u'id': 743121, u'imageType': u'jpeg'}
